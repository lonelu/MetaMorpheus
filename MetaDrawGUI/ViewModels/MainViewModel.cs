...
namespace ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        //Normal peptides
        public void UpdateForSingle(MsDataScan MsScanForDraw, PsmFromTsv psmParentsForDraw)
        {
            //// x is m/z, y is intensity
            //var x = MsScanForDraw.MassSpectrum.XArray;
            //var y = MsScanForDraw.MassSpectrum.YArray;
            
            //string scanNum = psmParentsForDraw.Ms2ScanNumber.ToString();
            //string fullSeq = psmParentsForDraw.FullSequence;

            //var matchedIonDic = psmParentsForDraw.MatchedIons;
        ...
        public void UpdateCrosslinkModel(Ms2ScanWithSpecificMass MsScanForDraw, PsmFromTsv psmParentsForDraw)
        {
        ...
        public void XLDrawMSMatchToPdf(Ms2ScanWithSpecificMass MsScanForDraw, PsmFromTsv psmParentsForDraw, int order, string OutputFolder)
        {
            //var x = MsScanForDraw.TheScan.MassSpectrum.XArray;
            //var y = MsScanForDraw.TheScan.MassSpectrum.YArray;
