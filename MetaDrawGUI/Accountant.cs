    ...
    public class Accountant
    {
        public void ExtractScanNumTime(List<string> MsDataFilePaths, MyFileManager spectraFileManager)
        {
            ...
            foreach (var filePath in MsDataFilePaths)
            {
                ...
                WriteExtractedInfo(filePath, Path.GetFileNameWithoutExtension(filePath)+"_time", times);

            }
        }

        private void WriteExtractedInfo(string FilePath, string name, List<Tuple<double, double, double, double, string, string, string>> times)
        {
